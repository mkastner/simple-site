...
const globIntentPatterns = require('../utils/glob-intent-patterns');
...
async function buildPage({
  ...
  try {
    ...
    const page = preferredIntents.get('layout')({ body: template });
